                ...
                <form className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="password"
                            className={`mb-16
                             mt-1 block w-full px-4 py-2 border rounded-md shadow-sm focus:outline-none focus:${primaryGreen} focus:${primaryGreen} text-lg placeholder-[#BFBFBF] border-[${primaryGreen}] text-[#949494]`}
                    ...
                    <div>
                        <button
                            type="submit"
                            className={`w-full bg-[${primaryGreen}] text-black font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:${primaryGreen}`}
                        >
                            entrar
                        </button>
                    </div>
